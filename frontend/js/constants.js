...
const welcome_h1 = "Welcome to the BitPuppyz NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The aim is to make an unbreakable project around NFTs and to build a long term project in whole series of Web 3.0. ';
